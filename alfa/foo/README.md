...
* [`src/cljs/foo/`](src/cljs/foo/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/foo/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `foo` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/foo/config.cljs) defaults to `true` in
